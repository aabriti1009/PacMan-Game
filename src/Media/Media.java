...
public class Media {
    ...
    static private void importMedia() throws IOException  {
        ...
        try {
            ...
            newImage.put(EImage.logo, scaleImg(ImageIO.read(getStreamfromResource("res/img/logo.png")), baseScale));
            ...
            newImage.put(EImage.food, scaleImg(ImageIO.read(getStreamfromResource("res/img/small_food.png")), baseScale));
